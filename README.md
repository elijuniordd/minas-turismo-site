...
- Nome:Eli Júnior Domingos Dias 
- Matricula: 892002
- Proposta de projeto escolhida: Guia Turístico
- Breve descrição sobre seu projeto:"Minas Bão pra Visitar" é um guia turístico online que destaca os encantos do interior de Minas Gerais, inicialmente focado nas cidades de Araxá e Campos Altos. O site oferece uma visão completa dos lugares mais vistosos e menos conhecidos dessas regiões.
